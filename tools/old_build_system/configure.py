...
COREBLAS requires a C compiler that supports C99 and OpenMP 4.0 with task depend.
...
COREBLAS can optionally compile Fortran 2008 interfaces, if a suitable Fortran
compiler is available. You can set $FC to your Fortran compiler.

COREBLAS requires BLAS, CBLAS, LAPACK, and LAPACKE libraries. These are often
