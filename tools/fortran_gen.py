...
description = '''\
Generates Fortran 2003 interface from COREBLAS header files.'''

help = '''\
----------------------------------------------------------------------
Example uses:

  fortran_gen.py coreblas_*.h
      generates coreblas_mod.f90 with module coreblas
...
types_dict = {
    ...
    "coreblas_complex64_t":("complex(kind=c_double_complex)"),
    "coreblas_complex32_t":("complex(kind=c_float_complex)"),
    "coreblas_enum_t":     ("integer(kind=c_int)"),
    "coreblas_desc_t":     ("type(coreblas_desc_t)"),
    "coreblas_workspace_t":("type(coreblas_workspace_t)"),
    "coreblas_sequence_t": ("type(coreblas_sequence_t)"),
    "coreblas_request_t":  ("type(coreblas_request_t)"),
    "coreblas_context_t":  ("type(coreblas_context_t)"),
    "coreblas_barrier_t":  ("type(coreblas_barrier_t)"),
...
return_variables_dict = {
    "double":            ("value"),
    "float":             ("value"),
    "coreblas_desc_t":     ("desc"),
    "coreblas_workspace_t":("workspace"),
    "coreblas_sequence_t": ("sequence"),
    "coreblas_request_t":  ("request"),
    "coreblas_context_t":  ("context"),
    "coreblas_enum_t":     ("enum"),
    "lua_State":         ("lua_state"),
}
