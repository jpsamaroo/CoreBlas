...
subs = {
  ...
  'mixed': [
    ...
    ('CoreBlasTrans',          'CoreBlas_ConjTrans'    ),
    ...
    # ----- COREBLAS / MAGMA data types
    ('double',               'magmaDoubleComplex'  ),
    ('float',                'magmaFloatComplex'   ),
    ('double',               'coreblas_complex64_t'  ),
    ('float',                'coreblas_complex32_t'  ),
    ('CoreBlasRealDouble',     'CoreBlasComplexDouble' ),
    ('CoreBlasRealFloat',      'CoreBlasComplexFloat'  ),

    # ----- COREBLAS / MAGMA functions, alphabetic order
    ('ddesc2ge',             'zdesc2ge'            ),
    ('dge2desc',             'zge2desc'            ),
    ('ddesc2pb',             'zdesc2pb'            ),
    ('dpb2desc',             'zpb2desc'            ),
    ...
    #('LAPACKE_d',            'LAPACKE_z'           ),
    #('LAPACKE_s',            'LAPACKE_c',          ),
    #('coreblas_d',             'coreblas_z'            ),
    #('coreblas_s',             'coreblas_c'            ),
  ...
  'normal': [
    ...
    (r'\bfabsf\b',          r'\bfabs\b',       r'\bcoreblas_scabs1\b', r'\bcoreblas_dcabs1\b'),  # this is for function names
    ...
    # Only for zlarfb and zunm*, convert it using special Magma_ConjTrans and CoreBlas_ConjTrans
    # aliases.
    ('MagmaTrans',           'MagmaTrans',           'Magma_ConjTrans',      'Magma_ConjTrans'     ),
    ('CoreBlasTrans',          'CoreBlasTrans',          'CoreBlas_ConjTrans',     'CoreBlas_ConjTrans'    ),
    ...
    # ----- COREBLAS / MAGMA constants
    ('CoreBlasRealFloat',      'CoreBlasRealDouble',     'CoreBlasComplexFloat',   'CoreBlasComplexDouble' ),

    # ----- COREBLAS / MAGMA data types
    ('float',                'double',               'magmaFloatComplex',    'magmaDoubleComplex'  ),
    ('float',                'double',               'coreblas_complex32_t',   'coreblas_complex64_t'  ),
    ('float',                'double',               'float',                'double'              ),
