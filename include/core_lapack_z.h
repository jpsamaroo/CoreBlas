...
#ifndef COREBLAS_CORE_LAPACK_Z_H
#define COREBLAS_CORE_LAPACK_Z_H
...
double LAPACK_zlantr(const char *norm, const char *uplo, const char *diag,
                     ...
                     const coreblas_complex64_t *A, const lapack_int *lda,
                     double *work);
#endif
...
void LAPACK_zlascl(const char *type, const lapack_int *kl, const lapack_int *ku,
                   ...
                   const lapack_int *m, const lapack_int *n,
                   coreblas_complex64_t *A, const lapack_int *lda,
                   lapack_int *info);
#endif
...
void LAPACK_zlassq(const lapack_int *n, const coreblas_complex64_t *x, const lapack_int *incx,
...
#endif // COREBLAS_CORE_LAPACK_Z_H
