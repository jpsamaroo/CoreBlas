...
void coreblas_kernel_zherk(coreblas_enum_t uplo, coreblas_enum_t trans,
                    int n, int k,
                    double alpha, const coreblas_complex64_t *A, int lda,
                    double beta,        coreblas_complex64_t *C, int ldc);

void coreblas_kernel_zhessq(coreblas_enum_t uplo,
                     int n,
                     const coreblas_complex64_t *A, int lda,
                     double *scale, double *sumsq);
...
void coreblas_kernel_zlange(coreblas_enum_t norm,
                     int m, int n,
                     const coreblas_complex64_t *A, int lda,
                     double *work, double *result);

void coreblas_kernel_zlange_aux(coreblas_enum_t norm,
                         int m, int n,
                         const coreblas_complex64_t *A, int lda,
                         double *value);
...
void coreblas_kernel_zlauum(coreblas_enum_t uplo,
                     int n,
                     coreblas_complex64_t *A, int lda);
...
void coreblas_kernel_ztslqt(int m, int n, int ib,
                     coreblas_complex64_t *A1, int lda1,
                     coreblas_complex64_t *A2, int lda2,
                     coreblas_complex64_t *T,  int ldt,
                     coreblas_complex64_t *work);
