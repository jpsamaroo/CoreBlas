 ...
 * @file bulge.h
 *
 *  COREBLAS auxiliary routines
 *  COREBLAS is a software package provided by Univ. of Tennessee,
 ...
 **/
#ifndef _COREBLAS_BULGE_H_
#define _COREBLAS_BULGE_H_
...
inline static int coreblas_ceildiv(int a, int b);
