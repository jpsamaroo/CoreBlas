 ...
 *
 * @generated from core_blas/core_zttlqt.c, normal z -> d, Mon Mar 18 06:35:39 2024
 *
 **/
                ...
                double *work)
{
    ...
    //core_dlaset(CoreBlasGeneral, ib, m, 0.0, 0.0, T, ldt);
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_dttlqt(m, n, ib,
                           A1, lda1,
                           A2, lda2,
                           T,  ldt,
                           tau,
