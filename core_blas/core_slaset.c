 ...
 *
 * @generated from core_blas/core_zlaset.c, normal z -> s, Mon Mar 18 06:35:35 2024
 *
 **/
 ...
 ******************************************************************************/
__attribute__((weak))
void coreblas_slaset(coreblas_enum_t uplo, int m, int n,
