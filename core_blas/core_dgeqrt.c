 ...
 *
 * @generated from core_blas/core_zgeqrt.c, normal z -> d, Mon Mar 18 06:35:32 2024
 *
 **/
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_dgeqrt(m, n, ib,
                           A, lda,
                           T, ldt,
                           tau,
                           tau+n);
    if (info != CoreBlasSuccess) {
        coreblas_error("core_dgeqrt() failed");
    }
}
