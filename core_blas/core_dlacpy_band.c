 ...
 *
 * @generated from core_blas/core_zlacpy_band.c, normal z -> d, Mon Mar 18 06:35:31 2024
 *
 **/
 ...
 * @ingroup core_double
 *
 *  coreblas_dlacpy copies a sub-block A of a band matrix stored in LAPACK's band format
                                            ...
                                            double *B, int ldb)
{
    ...
    coreblas_dlacpy_lapack2tile_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 A, lda,
                                 B, ldb);
}
 ...
 * @ingroup core_double
 *
 *  coreblas_dlacpy copies all or part of a two-dimensional matrix A to another
 *  matrix B
 *
 *******************************************************************************
 *
                                            ...
                                            double *A, int lda)
{
    ...
    coreblas_dlacpy_tile2lapack_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 B, ldb,
                                 A, lda);
}
