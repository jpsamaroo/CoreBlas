 ...
 *
 * @generated from core_blas/core_zparfb.c, normal z -> d, Mon Mar 18 06:35:41 2024
 *
 **/
 ...
 ******************************************************************************/
__attribute__((weak))
int coreblas_dparfb(coreblas_enum_t side, coreblas_enum_t trans,
                      ...
                      double *work, int ldwork)
{
    ...
    if (direct == CoreBlasForward) {
        ...
        if (side == CoreBlasLeft) {
            ...
            // W = A1 + op(V) * A2
            coreblas_dpamm(CoreBlasW, CoreBlasLeft, storev,
                       k, n1, m2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - op(V) * W
            // W = V * W, A2 = A2 - W
            coreblas_dpamm(CoreBlasA2, CoreBlasLeft, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
        ...
        //==============================
            ...
            // W = A1 + A2 * op(V)
            coreblas_dpamm(CoreBlasW, CoreBlasRight, storev,
                       m1, k, n2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - W * op(V)
            // W = W * V^T, A2 = A2 - W
            coreblas_dpamm(CoreBlasA2, CoreBlasRight, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
