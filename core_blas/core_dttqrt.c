 ...
 *
 * @generated from core_blas/core_zttqrt.c, normal z -> d, Mon Mar 18 06:35:40 2024
 *
 **/
                ...
                double *work)
{
    ...
    //core_dlaset(CoreBlasGeneral, ib, n, 0.0, 0.0, T, ldt);
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_dttqrt(m, n, ib,
                           A1, lda1,
                           A2, lda2,
                           T,  ldt,
                           tau,
    ...
    if (info != CoreBlasSuccess) {
        coreblas_error("core_dttqrt() failed");
    }
