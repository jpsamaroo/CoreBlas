 ...
 *
 * @generated from core_blas/core_zlange.c, normal z -> c, Mon Mar 18 06:35:34 2024
 *
 **/
 ...
 ******************************************************************************/
__attribute__((weak))
void coreblas_clange(coreblas_enum_t norm, int m, int n,
...
/******************************************************************************/
void coreblas_kernel_clange(coreblas_enum_t norm, int m, int n,
                     const coreblas_complex32_t *A, int lda,
                     float *work, float *value)
{

    coreblas_clange(norm, m, n, A, lda, work, value);
}

/******************************************************************************/
void coreblas_kernel_clange_aux(coreblas_enum_t norm, int m, int n,
                         const coreblas_complex32_t *A, int lda,
                         float *value)
{
    switch (norm) {
