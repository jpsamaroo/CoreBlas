 ...
 *
 * @generated from core_blas/core_zparfb.c, normal z -> s, Mon Mar 18 06:35:41 2024
 *
 **/
 ...
 ******************************************************************************/
__attribute__((weak))
int coreblas_sparfb(coreblas_enum_t side, coreblas_enum_t trans,
                      ...
                      float *work, int ldwork)
{
    ...
    if (direct == CoreBlasForward) {
        ...
        if (side == CoreBlasLeft) {
            ...
            // W = A1 + op(V) * A2
            coreblas_spamm(CoreBlasW, CoreBlasLeft, storev,
                       k, n1, m2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - op(V) * W
            // W = V * W, A2 = A2 - W
            coreblas_spamm(CoreBlasA2, CoreBlasLeft, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
        ...
        //==============================
            ...
            // W = A1 + A2 * op(V)
            coreblas_spamm(CoreBlasW, CoreBlasRight, storev,
                       m1, k, n2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - W * op(V)
            // W = W * V^T, A2 = A2 - W
            coreblas_spamm(CoreBlasA2, CoreBlasRight, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
