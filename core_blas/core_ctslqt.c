 ...
 *
 * @generated from core_blas/core_ztslqt.c, normal z -> c, Mon Mar 18 06:35:39 2024
 *
 **/
    ...
    for (int ii = 0; ii < m; ii += ib) {
        ...
        for (int i = 0; i < sb; i++) {
            ...
            if (ii+i+1 < m) {
                ...
                cblas_cgemv(CblasColMajor, (CBLAS_TRANSPOSE)CoreBlasNoTrans,
                            sb-i-1, n,
        ...
        if (m > ii+sb) {
            coreblas_ctsmlq(CoreBlasRight, CoreBlas_ConjTrans,
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_ctslqt(m, n, ib,
                           A1, lda1,
                           A2, lda2,
                           T,  ldt,
                           tau,
    ...
    if (info != CoreBlasSuccess) {
        coreblas_error("core_ctslqt() failed");
    }
