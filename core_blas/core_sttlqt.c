 ...
 *
 * @generated from core_blas/core_zttlqt.c, normal z -> s, Mon Mar 18 06:35:39 2024
 *
 **/
                ...
                float *work)
{
    ...
    //core_slaset(CoreBlasGeneral, ib, m, 0.0, 0.0, T, ldt);
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_sttlqt(m, n, ib,
                           A1, lda1,
                           A2, lda2,
                           T,  ldt,
                           tau,
    ...
    if (info != CoreBlasSuccess) {
        coreblas_error("core_stslqt() failed");
    }
