 ...
 *
 * @generated from core_blas/core_zgbtype1cb.c, normal z -> s, Mon Mar 18 06:35:41 2024
 *
 **/
                     ...
                     float *WORK)
{
    ...
    if( uplo == CoreBlasUpper ) {
        ...
        *AU(st-1, st) = ctmp;
        ...
        ctmp = *TAUP(taupos);
        LAPACKE_slarfx_work(LAPACK_COL_MAJOR, 'R',
        ...
        *VQ(vpos) = 1.;
        ...
        lenj = len-1;
        ctmp = (*TAUQ(taupos));
        LAPACKE_slarfx_work(LAPACK_COL_MAJOR, 'L',
