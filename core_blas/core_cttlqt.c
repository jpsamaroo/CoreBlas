 ...
 *
 * @generated from core_blas/core_zttlqt.c, normal z -> c, Mon Mar 18 06:35:40 2024
 *
 **/
                ...
                coreblas_complex32_t *work)
{
    ...
    //core_claset(CoreBlasGeneral, ib, m, 0.0, 0.0, T, ldt);
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_cttlqt(m, n, ib,
                           A1, lda1,
                           A2, lda2,
                           T,  ldt,
                           tau,
