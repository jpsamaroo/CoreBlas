 ...
 *
 * @generated from core_blas/core_ztsqrt.c, normal z -> d, Mon Mar 18 06:35:39 2024
 *
 **/
                ...
                double *work)
{
    ...
    for (int ii = 0; ii < n; ii += ib) {
        ...
        for (int i = 0; i < sb; i++) {
...
#endif
                cblas_dgemv(CblasColMajor, (CBLAS_TRANSPOSE)CoreBlasTrans,
                            m, sb-i-1,
            ...
            cblas_dtrmv(CblasColMajor, (CBLAS_UPLO)CoreBlasUpper,
        ...
        if (n > ii+sb) {
            coreblas_dtsmqr(CoreBlasLeft, CoreBlasTrans,
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_dtsqrt(m, n, ib,
                           A1, lda1,
                           A2, lda2,
                           T,  ldt,
                           tau,
    ...
    if (info != CoreBlasSuccess) {
        coreblas_error("core_dtsqrt() failed");
    }
