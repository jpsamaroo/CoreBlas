 ...
 *
 * @generated from core_blas/core_ztsmlq.c, normal z -> s, Mon Mar 18 06:35:39 2024
 *
 **/
 ...
 *    Q = H(k)^T . . . H(2)^T H(1)^T
 *
 *  as returned by coreblas_stslqt.
 *
 *******************************************************************************
 *
 * @param[in] side
 ...
 *         coreblas_stslqt in the first k rows of its array argument V.
 *
 * @param[in] ldv
                      ...
                      float *work, int ldwork)
{
    ...
    for (int i = i1; i > -1 && i < k; i += i3) {
        ...
        // Apply H or H^T.
        coreblas_sparfb(side, trans, CoreBlasForward, CoreBlasRowwise,
                    mi, ni, m2, n2, kb, 0,
                    &A1[lda1*jc+ic], lda1,
                    A2, lda2,
                    &V[i], ldv,
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_stsmlq(side, trans,
                           m1, n1, m2, n2, k, ib,
                           A1, lda1,
                           A2, lda2,
                           V,  ldv,
    ...
    if (info != CoreBlasSuccess) {
        coreblas_error("core_stsmlq() failed");
    }
