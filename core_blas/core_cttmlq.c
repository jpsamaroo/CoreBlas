 ...
 *
 * @generated from core_blas/core_zttmlq.c, normal z -> c, Mon Mar 18 06:35:40 2024
 *
 **/
 ...
 *    Q = H(k)^H . . . H(2)^H H(1)^H
 *
 *  as returned by coreblas_cttlqt.
 *
 *******************************************************************************
 *
 * @param[in] side
 ...
 *         coreblas_cttlqt in the first k rows of its array argument V.
 *
 * @param[in] ldv
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_cttmlq(side, trans,
                           m1, n1, m2, n2, k, ib,
                           A1, lda1,
                           A2, lda2,
                           V,  ldv,
    ...
    if (info != CoreBlasSuccess) {
        coreblas_error("core_cttmlq() failed");
    }
}
