 ...
 *
 * @generated from core_blas/core_zttmlq.c, normal z -> s, Mon Mar 18 06:35:40 2024
 *
 **/
 ...
 *    Q = H(k)^T . . . H(2)^T H(1)^T
 *
 *  as returned by coreblas_sttlqt.
 *
 *******************************************************************************
 *
 * @param[in] side
 ...
 *         coreblas_sttlqt in the first k rows of its array argument V.
 *
 * @param[in] ldv
                     ...
                     coreblas_workspace_t work)
{
    ...
    // Call the kernel.
    int info = coreblas_sttmlq(side, trans,
                           m1, n1, m2, n2, k, ib,
                           A1, lda1,
                           A2, lda2,
                           V,  ldv,
    ...
    if (info != CoreBlasSuccess) {
        coreblas_error("core_sttmlq() failed");
    }
}
