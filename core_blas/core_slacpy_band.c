 ...
 *
 * @generated from core_blas/core_zlacpy_band.c, normal z -> s, Mon Mar 18 06:35:31 2024
 *
 **/
 ...
 * @ingroup core_float
 *
 *  coreblas_slacpy copies a sub-block A of a band matrix stored in LAPACK's band format
                                            ...
                                            float *B, int ldb)
{
    ...
    coreblas_slacpy_lapack2tile_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 A, lda,
                                 B, ldb);
}
 ...
 * @ingroup core_float
 *
 *  coreblas_slacpy copies all or part of a two-dimensional matrix A to another
 *  matrix B
 *
 *******************************************************************************
 *
                                            ...
                                            float *A, int lda)
{
    ...
    coreblas_slacpy_tile2lapack_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 B, ldb,
                                 A, lda);
}
